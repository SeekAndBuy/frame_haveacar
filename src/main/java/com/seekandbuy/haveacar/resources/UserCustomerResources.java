...
public class UserCustomerResources implements GenericResources<CustomerUser>
{	
	@Autowired
	private CustomerUserService userService;
	
	public UserCustomerResources(CustomerUserService userService) 
	{
	...
	public ResponseEntity<List<CustomerUser>> listItem() {
		return ResponseEntity.status(HttpStatus.OK).body(userService.listItem());
	}

	@Override
	@RequestMapping(method = RequestMethod.POST)	
	public ResponseEntity<Void> createItem(@RequestBody CustomerUser user) {
	...
	public ResponseEntity<Optional<CustomerUser>> findItem(@PathVariable("id") Long id) {
		Optional<CustomerUser> user = null;
		try
		{
	...
	public ResponseEntity<Void> updateItem(@RequestBody CustomerUser user,  @PathVariable("id") Long id) {
